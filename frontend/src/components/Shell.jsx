...
const GROUPS = [ // sidebar sections: label + [iconKey, label, route] rows (data-driven nav = add a row, get a link)
  ...
  { label: 'Grow', items: [['insights', 'Insights', '/insights'], ['vendoraai', 'Vendora AI', '/vendora-ai'], ['gift', 'Refer & Earn', '/refer-earn'], ['billing', 'Billing', '/billing']] },
...
const TITLES = { '/dashboard': 'Overview', '/chats': 'Inbox', '/catalog': 'Catalog', '/connect': 'Connect channels', '/playground': 'Test your bot', '/insights': 'Insights', '/vendora-ai': 'Vendora AI', '/refer-earn': 'Refer & Earn', '/billing': 'Billing', '/profile': 'Business profile', '/settings': 'AI settings', '/help': 'Help', '/onboarding': 'Get started', '/login': 'Sign in' }; // object lookup: path → human title (topbar breadcrumb + document.title)
