...
const FAQS = [ // 15 pairs — CUSTOMER voice (plain answers, zero jargon; in-app Help rephrases for owners)
  ...
  ['How does billing work?', 'Pricing adapts to your location automatically — Naira in Nigeria, US Dollars everywhere else — starting from ₦7,500 or $5 per month, with yearly and lifetime options. Pay by card or direct bank transfer. Dropping to free never deletes anything.'],
