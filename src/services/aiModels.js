...
const CATALOG = [
  ...
  { id: 'kimi-k2', label: 'Kimi K2', provider: 'groq', tier: 'paid', minTier: 'plus', badge: 'Premium', desc: 'Moonshot · agentic tasks · Pro Plus', // THE crown jewel (Moonshot — Plus-only heavy work model, upsell modal on tap!)
