    ...
    <div className="landing">
      ...
      <section className="landing-inner" style={{ padding: '48px 24px 64px' }}>
        <div className="card legal reveal vis">
          ...
          <p>Vendora rides on WhatsApp/Meta, Telegram, AI providers (Gemini/Groq/OpenRouter/Anthropic/OpenAI), Paystack, Flutterwave, and our hosts. If any of them has an outage, changes prices, or changes rules, parts of Vendora may degrade — and that isn't our breach. We'll always fail safe (flag to human, never invent answers) and post status in the dashboard when we can.</p>
